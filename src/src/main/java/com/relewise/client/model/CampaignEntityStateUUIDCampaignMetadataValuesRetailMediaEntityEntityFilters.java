...
public abstract class CampaignEntityStateUUIDCampaignMetadataValuesRetailMediaEntityEntityFilters
{
    ...
    public CampaignEntityStateUUIDCampaignMetadataValuesRetailMediaEntityEntityFilters setTerm(@Nullable String term)
    {
        this.term = term;
        return this;
    }
    public CampaignEntityStateUUIDCampaignMetadataValuesRetailMediaEntityEntityFilters setStates(CampaignEntityState... states)
    {
        this.states = states;
        return this;
    }
