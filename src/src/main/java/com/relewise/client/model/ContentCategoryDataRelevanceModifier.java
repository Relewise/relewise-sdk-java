...
/** a <code>RelevanceModifier</code> that can change the relevance of a ContentCategory depending on matching conditions on a certain key. */
@JsonTypeInfo(
...
public class ContentCategoryDataRelevanceModifier extends DataRelevanceModifier implements IContentCategoryRelevanceModifier
{
    ...
    public static ContentCategoryDataRelevanceModifier create(String key, ArrayList<ValueCondition> conditions, ValueSelector multiplierSelector)
    {
        return new ContentCategoryDataRelevanceModifier(key, conditions, multiplierSelector);
    }
    public ContentCategoryDataRelevanceModifier(String key, ArrayList<ValueCondition> conditions, ValueSelector multiplierSelector)
    {
        this.key = key;
