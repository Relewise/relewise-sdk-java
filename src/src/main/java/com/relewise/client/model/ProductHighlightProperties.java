...
public abstract class ProductHighlightProperties
{
    public String $type = "";
    ...
    /** If highlights should include display name. */
    public ProductHighlightProperties setDisplayName(Boolean displayName)
    {
        this.displayName = displayName;
        return this;
    }
    public ProductHighlightProperties setDataKeys(String... dataKeys)
    {
        this.dataKeys = dataKeys;
        return this;
    }
    public ProductHighlightProperties addToDataKeys(String dataKey)
    {
