...
@JsonTypeInfo(
    ...
    property = "$type",
    defaultImpl = ProductIndexConfiguration.class)
public class ProductIndexConfiguration
{
    public String $type = "Relewise.Client.DataTypes.Search.Configuration.ProductIndexConfiguration, Relewise.Client";
