...
@JsonTypeInfo(
    ...
    property = "$type",
    defaultImpl = RecommendPopularSearchTermSettings.class)
@JsonIgnoreProperties(ignoreUnknown = true)
public class RecommendPopularSearchTermSettings
{
    public String $type = "Relewise.Client.Requests.Recommendations.RecommendPopularSearchTermSettings, Relewise.Client";
