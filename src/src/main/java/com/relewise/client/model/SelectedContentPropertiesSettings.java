...
@JsonTypeInfo(
    ...
    property = "$type",
    defaultImpl = SelectedContentPropertiesSettings.class)
public class SelectedContentPropertiesSettings
{
    public String $type = "Relewise.Client.Requests.Shared.SelectedContentPropertiesSettings, Relewise.Client";
